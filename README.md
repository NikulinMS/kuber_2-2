# Домашнее задание к занятию "`Хранение в K8s. Часть 2`" - `Никулин Михаил Сергеевич`
...
```bash
nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl create ns dz2-2
namespace/dz2-2 created
nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl get ns
NAME              STATUS   AGE
...
```
```bash
nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl apply -f deployment_busybox_multitool.yaml 
deployment.apps/netology-app-multitool-busybox created

nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl get pods -n dz2-2 -o wide
NAME                                             READY   STATUS    RESTARTS   AGE   IP             NODE          NOMINATED NODE   READINESS GATES
netology-app-multitool-busybox-5d49bd56d-q2k9q   2/2     Running   0          23s   10.1.123.134   netology-01   <none>           <none>

nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl get deployment -n dz2-2
...
```
```bash
nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl apply -f pv_vol.yaml 
persistentvolume/pv created

nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl get pv
...
```
```bash
nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl apply -f pvc_vol.yaml 
...
```bash
nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl exec netology-app-multitool-busybox-5d49bd56d-q2k9q -n dz2-2 -c multitool -it -- sh
...
```bash
nikulinn@nikulin:~/other/kuber_2-2/scr$ ssh debian@158.160.40.165
...
Удаляем deployment:
```bash
nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl delete -n dz2-2 -f deployment_busybox_multitool.yaml 
...
```bash
nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl delete -f pvc_vol.yaml 
persistentvolumeclaim "pvc-vol" deleted

nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl get pvc -n dz2-2
No resources found in dz2-2 namespace.

nikulinn@nikulin:~/other/kuber_2-2/scr$ kubectl delete -f pv_vol.yaml 
